    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><strong>Nome Completo:</strong> Nome do Usuário</li>
                    <li class="list-group-item"><strong>Email:</strong> usuario@example.com</li>
                    <li class="list-group-item"><strong>Telefone:</strong> (11) 1234-5678</li>
                    <li class="list-group-item"><strong>Endereço:</strong> Rua Exemplo, 123, Cidade, Estado</li>
